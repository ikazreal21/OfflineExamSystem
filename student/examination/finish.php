...
$yearlevel = $student_details[0]['yearlevel'];
    ...
    if (empty($errors)) {
        ...
        $statement = $pdo->prepare("INSERT INTO exam_take (exam_id, student_name, student_id, subject, 	subject_id, 	grading_per, score, out_of, yearl) VALUES (:exam_id, :student_name, :student_id, :subject, :subject_id, :grading_per, :score, :out_of, :yearl)");
